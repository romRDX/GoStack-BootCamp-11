...
- Utilizar Mailttrap para testar envios em ambiente de dev;
...
- A notificação deve ter un status de lida ou não-lida para que o prestador possa controlar;
...
- O usuário deve poder listar ods dias de um mês com pelo menos um horário disponivel de um prestador;
